...
const ViewAdmins = () => {
    ...
    const fetchAdmins = async () => {
        ...
        const arrayData = Object.entries(data).map(([key, value]) => ({ id: key, ...value }));
        setAdmins(arrayData);
    }

    const handleDeleteAdmin = () => {
        handleClose();
        deleteAdmin(selected.email, decrypt(selected.password))
            .then(res => {
                console.log(res)
                fetchAdmins();
                                        ...
                                        <TableRow key={admin.id}>
                                            ...
                                            <TableCell align="right">
                                                <IconButton onClick={() => {
                                                    ...
                                                    <DeleteIcon color="danger" sx={{cursor: "pointer"}}/>
                                                </IconButton>
                                            </TableCell>
                                        </TableRow>
                                    ))}
